...
import edu.mit.mitmobile.ModoLog;
import edu.mit.mitmobile.objs.NewsItem;
import edu.mit.mitmobile.objs.NewsItem.Image;
...
public class NewsHandler extends DefaultHandler{
	    ...
	    static final SimpleDateFormat sDateFormat = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss zzz");
