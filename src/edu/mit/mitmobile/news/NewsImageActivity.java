...
import edu.mit.mitmobile.ActivityPassingCache;
import edu.mit.mitmobile.LoadingUIHelper;
...
public class NewsImageActivity extends SliderActivity {
	...
	private class NewsImageView extends LockingScrollView {
		...
		public void populateView(NewsItem.Image image) {
			...
			imageWV.loadDataWithBaseURL(null, StyledContentHTML.imageHtml(image.fullURL), "text/html", "utf-8", null);
