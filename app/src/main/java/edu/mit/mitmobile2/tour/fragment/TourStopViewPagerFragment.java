...
public class TourStopViewPagerFragment extends Fragment implements TourStopScrollViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainLoopAdapter = new TourStopRecyclerViewAdapter(getActivity().getApplicationContext(), mainLoopStops, mitTourStop, true, tourSelfGuidedCallback);
        ...
        nearLoopAdapter = new TourStopRecyclerViewAdapter(getActivity().getApplicationContext(), nearHereStops, mitTourStop, false, tourSelfGuidedCallback);
